...
namespace Mapbox.Tokens
{
	...
	public enum MapboxTokenStatus
	{
		...
		[DescriptionAttr("The token is valid and active")]
		TokenValid,
		/// <summary>the token can not be parsed </summary>
		[DescriptionAttr("the token can not be parsed")]
		TokenMalformed,
		/// <summary>the signature for the token does not validate </summary>
		[DescriptionAttr("the signature for the token does not validate")]
		TokenInvalid,
		/// <summary> the token was temporary and expired</summary>
		[DescriptionAttr("the token was temporary and expired")]
		TokenExpired,
		/// <summary>the token's authorization has been revoked </summary>
		[DescriptionAttr("the token's authorization has been revoked")]
		TokenRevoked,
